/**
 * @typedef {import("@fullcalendar/core", {with: {"resolution-mode": "import"}}).EventMountArg} FullCalendar.EventMountArg
 */
...
class Calendar {
    ...
    static #calculateTimeDifference() {
        const startEl = /** @type {HTMLInputElement} */(document.getElementById("start")),
            endEl = /** @type {HTMLInputElement} */(document.getElementById("end"));
    ...
    static async #fetchAndDisplayGameResults(timeout) {
        ...
        const gameDropdownDiv = /** @type {HTMLDivElement} */(document.getElementById("game-dropdown")),
        ...
        const gameEl = /** @type {HTMLInputElement} */(document.getElementById("game"));
        let res;
    ...
    static #hideGameDropdown(ev) {
        const el = /** @type {HTMLElement} */(ev.target),
            gameDropdownDiv = /** @type {HTMLDivElement} */(document.getElementById("game-dropdown"));
    ...
    static async #openAddEventModal() {
        ...
        const modalDiv = /** @type {HTMLDivElement} */(document.getElementById("modal")),
            startEl = /** @type {HTMLInputElement} */(document.getElementById("start")),
            gameEl = /** @type {HTMLInputElement} */(document.getElementById("game")),
    ...
    static async #saveEvent() {
        const descriptionEl = /** @type {HTMLTextAreaElement} */(document.getElementById("description")),
            endEl = /** @type {HTMLInputElement} */(document.getElementById("end")),
            gameEl = /** @type {HTMLInputElement} */(document.getElementById("game")),
            saveBtn = /** @type {HTMLButtonElement} */(document.getElementById("save")),
            saveErrorDiv = /** @type {HTMLDivElement} */(document.getElementById("save-error")),
            startEl = /** @type {HTMLInputElement} */(document.getElementById("start")),
            titleEl = /** @type {HTMLInputElement} */(document.getElementById("title"));
    ...
    static #selectGame(ev) {
        let el = /** @type {HTMLDivElement} */(ev.target);
        const gameEl = /** @type {HTMLInputElement} */(document.getElementById("game")),
            descriptionEl = /** @type {HTMLTextAreaElement} */(document.getElementById("description"));

        while (!el.classList.contains("item")) {
            el = /** @type {HTMLDivElement} */(el.parentNode);
            if (!el || !el.classList) {
                return;
            }
        }

        gameEl.value = /** @type {HTMLDivElement} */(el.querySelector(".game")).innerText;
        Calendar.#gameId = Number(el.dataset.id);
