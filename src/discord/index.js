...
class Discord {
    ...
    static async queue(message, channel) {
        ...
        } catch { } // eslint-disable-line no-empty -- If the message fails to send, just fail silently.
        return msg;
    }
    ...
    static findCategoryByName(name) {
        ...
        return /** @type {DiscordJs.CategoryChannel} */(Discord.#guild.channels.cache.find((c) => c.name === name && c.type === DiscordJs.ChannelType.GuildCategory));
    }
    ...
    static findTextChannelByName(name) {
        ...
        return /** @type {DiscordJs.TextChannel} */(Discord.#guild.channels.cache.find((c) => c.name === name && c.type === DiscordJs.ChannelType.GuildText));
    }
    ...
    static findVoiceChannelByName(name) {
        ...
        return /** @type {DiscordJs.VoiceChannel} */(Discord.#guild.channels.cache.find((c) => c.name === name && c.type === DiscordJs.ChannelType.GuildVoice));
    }
    ...
    static isOwner(member) {
        return Boolean(member && Discord.#theEvilOverlordRole.members.find((m) => m.id === member.id));
    }
}
